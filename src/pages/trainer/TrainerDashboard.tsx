...
const TrainerDashboard = () => {
  ...
  // Find classes for attendees view (specific date)
  const getClassesForAttendeesView = () => {
    return mockClasses.filter(cls => 
      cls.date.getDate() === selectedDateForAttendees.getDate() &&
      cls.date.getMonth() === selectedDateForAttendees.getMonth() &&
      cls.date.getFullYear() === selectedDateForAttendees.getFullYear()
    );
  };
  
  const classesForView = getFilteredClasses();
  const classesForAttendees = getClassesForAttendeesView();
  ...
  const handleSelectClassForAttendees = (classId: number) => {
                    ...
                    classesForAttendees.map(cls => {
                      ...
                      return (
                        <div 
                          ...
                          onClick={() => handleSelectClassForAttendees(cls.id)}
                        >
